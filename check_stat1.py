...
def check_stat_job():
    ...
    [peat_stat_period, peat_stat_critical,alert_tab] = get_config(inifile, "peats_stat", ["period", "critical_limit", "alert_tab"])
    ...
    new_topic(smf_url, smf_user, smf_pass, 13.0, fdate, msg)
